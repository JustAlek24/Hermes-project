...
def get_in_connection(peer_id):
    """Возвращает writer входящего соединения пира, чтобы слать ему
    подтверждения, не дозваниваясь обратно по TCP."""
    return _in_connections.get(peer_id)
